package com.xiyuxian.picturecloudy.shared.auth;
...
import com.xiyuxian.picturecloudy.domain.space.valuobject.SpaceRoleEnum;
import com.xiyuxian.picturecloudy.domain.space.valuobject.SpaceTypeEnum;
...
import static com.xiyuxian.picturecloudy.domain.user.constant.UserConstant.USER_LOGIN_STATE;
...
//    private SpaceUser spaceUser;
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (spaceId == null) {
            ...
            // 公共图库，仅本人或管理员可操作
            if (spaceId == null) {
                if (picture.getUserId().equals(userId) || userDomainService.isAdmin(loginUser)) {
                    return ADMIN_PERMISSIONS;
                } else {
                    // 不是自己的图片，仅可查看
        ...
        if (space.getSpaceType() == SpaceTypeEnum.PRIVATE.getValue()) {
            // 私有空间，仅本人或管理员有权限
            if (space.getUserId().equals(userId) || userDomainService.isAdmin(loginUser)) {
                return ADMIN_PERMISSIONS;
            } else {
                return new ArrayList<>();
            }
